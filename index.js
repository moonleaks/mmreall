...
const DISCORD_TOKEN = process.env['DISCORD_TOKEN'] // Discord bot token (add it in the secrets)
    ...
    options: [
      {
        ...
        required: true,
        //client.party.me.setSittingOut(sittingOut)
...
(async () => {
  ...
  "secret": process.env['secret'] // Dont share this!
  }
  try {
